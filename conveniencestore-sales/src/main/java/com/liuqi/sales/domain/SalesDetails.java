...
public class SalesDetails extends BaseEntity
{
    ...
    /** 物品售卖类型(1:內售处理;2:外售处理;3:退货处理;4:换货处理;5:捆绑出售处理;) */
    @Excel(name = "物品售卖类型(1:內售处理;2:外售处理;3:退货处理;4:换货处理;5:捆绑出售处理;)")
    ...
    /** 捆绑销售主物品单号 */
    @Excel(name = "捆绑销售主物品单号")
    private String salesCodeBundle;
    ...
    public void setSalesCodeBundle(String salesCodeBundle)
    {
        this.salesCodeBundle = salesCodeBundle;
    }

    public String getSalesCodeBundle()
    {
        return salesCodeBundle;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("salesCodeBundle", getSalesCodeBundle())
                .toString();
    }
}
